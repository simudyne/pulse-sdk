...
class SimulationResource:
    ...
    def calibrate(
        ...
        -------
        dict
            Calibration job submission result
        """
        payload: dict = {
            "symbol": symbol,
            "cal_date": cal_date,
    ...
    def list_scenarios():
        ...
        -------
        dict
            Scenario names mapped to descriptions
    ...
    def get_scenario_defaults(scenario: str):
        ...
        -------
        dict
            Default parameter values, or empty dict for "normal"
    ...
    def get_sample_data(self, path: str = "simulation_sample.zip"):
        ...
        -------
        bytes
            ZIP file content if path is None, otherwise None (file written to disk).
    ...
    def get_bulk_data(
        ...
        -------
        bytes
            ZIP file content containing requested parquet files
